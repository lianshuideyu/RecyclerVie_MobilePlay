...
public class LocalAudioPager extends LinearLayout {
    ...
    public LocalAudioPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.e("TAG","LocalAudioPager构造器");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("本地音频",0,0,paint);
    }
}
